...
<div class="slogan container container--90">
  ...
  <div class="row">
    <div class="col-sm-6">
      <a href="<c:url value="/admin/institution/confirm-delete/${institution.id}"/>"><button type="button"  class="btn btn--without-border">Usuń</button></a>
      <a href="<c:url value="/admin/institution/edit/${institution.id}"/>"><button type="button"  class="btn btn--without-border">Edytuj</button></a>
    </div>
    <div class="col-sm-6">
    <h1>
      ${institution.name}<br>
